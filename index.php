...
<body>
	<header>
		...
		<div class="hero-text-box">
			<h1>Goodbye junk food.<br>Hello super health meals.</h1>
			<a href="#plans" class="btn btn-full js--scroll-to-plans">I'm hungry</a>
			<a href="#features" class="btn btn-ghost js--scroll-to-start">show me more</a>
		</div>
	</header>
	...
	<section class="section-steps" id="works">
		...
		<div class="row">
			<div class="col span-1-of-2 steps-box">
				<img src="resource/img/app-iPhone.png" alt="Omnifood app on app-iPhone" class="app-screen js--wp">
			</div>
			<div class="col span-1-of-2 steps-box">
					...
					<a href="#" class="btn-app"><img src="resource/img/download-app.svg" alt="App source Button"></a>
					<a href="#" class="btn-app"><img src="resource/img/download-app-android.png" alt="play store Button"></a>
				</div>
		</div>
	</section>
		...
		<div class="row">
			<div class="col span-1-of-3">
				<blockquote>
					...
					<cite><img src="resource/img/customer-1.jpg" alt="Customers-1-photo">Alberto Duncan</cite>
				</blockquote>
			</div>
			<div class="col span-1-of-3">
				<blockquote>
					Inexpensive, healthy and great-tasting meals, delivered right to my home. We have lots of food delivery here in Lisbon, but no one comes even close to Omifood. Me and my family are so in love!
					<cite><img src="resource/img/customer-2.jpg" alt="customers-2-photo">Joana Silva</cite>
				</blockquote>
			</div>
			<div class="col span-1-of-3">
				<blockquote>
	...
	<section class="section-plans js--section-plans js--wp-4" id="plans">
            <div class="row">
 ...
 -->
        ...
        <footer>
        	...
        	<div class="row">
        		<p>
        			Copyright &copy: 2017 by HalftoneDesign.All rights reserved.
        		</p>
        	</div>
        </footer>
